...
func main() {
	...
	communityUseCase := usecase.NewCommunityUseCase(store, conf, communityRepository, affiliationRepository, communityRestaurantsRepository, inviteTokenRepository)
	...
	handler := api.NewHandler(userUseCase, communityUseCase, restaurantUseCase, commentUseCase, bookmarkUseCase)
