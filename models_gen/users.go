...
type User struct {
	...
	// プロフィール画像のファイル名
	ProfileImageFile null.String `boil:"profile_image_file" json:"profile_image_file,omitempty" toml:"profile_image_file" yaml:"profile_image_file,omitempty"`
...
var UserTableColumns = struct {
	...
	ID:               "users.id",
	Name:             "users.name",
	ProfileImageFile: "users.profile_image_file",
...
var UserWhere = struct {
	...
	ProfileImageFile whereHelpernull_String
	CreatedAt        whereHelpertime_Time
	UpdatedAt        whereHelpertime_Time
}{
	ID:               whereHelperint64{field: "`users`.`id`"},
	Name:             whereHelperstring{field: "`users`.`name`"},
	ProfileImageFile: whereHelpernull_String{field: "`users`.`profile_image_file`"},
...
var (
	userAllColumns            = []string{"id", "name", "profile_image_file", "created_at", "updated_at"}
	userColumnsWithoutDefault = []string{"name", "profile_image_file"}
...
func (q userQuery) One(ctx context.Context, exec boil.ContextExecutor) (*User, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "models_gen: failed to execute a one query for users")
	}
...
func (q userQuery) All(ctx context.Context, exec boil.ContextExecutor) (UserSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "models_gen: failed to assign all query results to User slice")
	}
...
func (q userQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "models_gen: failed to count users rows")
	}
...
func (q userQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "models_gen: failed to check if users exists")
	}
...
func (o *User) Affiliations(mods ...qm.QueryMod) affiliationQuery {
	...
	queryMods = append(queryMods,
		qm.Where("`affiliation`.`user_id`=?", o.ID),
	)
...
func (userL) LoadAffiliations(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	var slice []*User
	var object *User
	...
	query := NewQuery(
		qm.From(`affiliation`),
		qm.WhereIn(`affiliation.user_id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (userL) LoadBookmarks(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	var slice []*User
	var object *User
...
func FindUser(ctx context.Context, exec boil.ContextExecutor, iD int64, selectCols ...string) (*User, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "models_gen: unable to select from users")
	}
...
func (o *User) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("models_gen: no users provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "models_gen: unable to insert into users")
	}
	...
	if err != nil {
		return errors.Wrap(err, "models_gen: unable to populate default values for users")
	}
...
func (o *User) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("models_gen: unable to update users, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "models_gen: unable to update users row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "models_gen: failed to get rows affected by update for users")
	}
...
func (q userQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "models_gen: unable to update all for users")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "models_gen: unable to retrieve rows affected for users")
	}
...
func (o UserSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "models_gen: unable to update all in user slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "models_gen: unable to retrieve rows affected all in update all user")
	}
	return rowsAff, nil
}
...
func (o *User) Upsert(ctx context.Context, exec boil.ContextExecutor, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("models_gen: no users provided for upsert")
	}
	if !boil.TimestampsAreSkipped(ctx) {
		currTime := time.Now().In(boil.GetLocation())
	...
	if !cached {
		...
		if !updateColumns.IsNone() && len(update) == 0 {
			return errors.New("models_gen: unable to upsert users, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "models_gen: unable to upsert for users")
	}
	...
	if err != nil {
		return errors.Wrap(err, "models_gen: unable to retrieve unique values for users")
	}
...
func (o *User) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("models_gen: no User provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "models_gen: unable to delete from users")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "models_gen: failed to get rows affected by delete for users")
	}
...
func (q userQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("models_gen: no userQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "models_gen: unable to delete all from users")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "models_gen: failed to get rows affected by deleteall for users")
	}
...
func (o UserSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "models_gen: unable to delete all from user slice")
	}
...
func (o *UserSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "models_gen: unable to reload all in UserSlice")
	}
...
func UserExists(ctx context.Context, exec boil.ContextExecutor, iD int64) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "models_gen: unable to check if users exists")
	}
